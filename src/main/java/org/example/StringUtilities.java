...
public class StringUtilities {
    ...
    // characters
    public static boolean shortString(String shortString){
        int shortStringLength = shortString.length();
        if(shortStringLength < 5) {
            return true;
        } else {
            return false;
        }
    ...
    public static char firstLetter(String firstLetter){
    ...
    public static String censorAsparagus (String censorAsparagus){
//        String text = censorAsparagus.toLowerCase();
        return censorAsparagus.replace("asparagus", "****");
    }
